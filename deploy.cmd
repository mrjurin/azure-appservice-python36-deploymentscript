...
:: Not needed in our functions
:: 4. Copy web.config
::IF EXIST "%DEPLOYMENT_SOURCE%\web.3.6.config" (
::  echo Overwriting web.config with web.3.6.config
::  copy /y "%DEPLOYMENT_SOURCE%\web.3.6.config" "%DEPLOYMENT_TARGET%\web.config"
::)
